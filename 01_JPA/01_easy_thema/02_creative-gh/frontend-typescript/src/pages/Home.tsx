        ...
        <div id="portfolio">
            <div className="container-fluid p-0">
                <div className="row g-0">
                    ...
                    <div className="col-lg-4 col-sm-6">
                        <a className="portfolio-box" href={require("../assets/img/portfolio/fullsize/2.jpg")} title="Project Name">
                    ...
                    <div className="col-lg-4 col-sm-6">
                        <a className="portfolio-box" href={require("../assets/img/portfolio/fullsize/3.jpg")} title="Project Name">
                    ...
                    <div className="col-lg-4 col-sm-6">
                        <a className="portfolio-box" href={require("../assets/img/portfolio/fullsize/4.jpg")} title="Project Name">
                    ...
                    <div className="col-lg-4 col-sm-6">
                        <a className="portfolio-box" href={require("../assets/img/portfolio/fullsize/5.jpg")} title="Project Name">
                    ...
                    <div className="col-lg-4 col-sm-6">
                        <a className="portfolio-box" href={require("../assets/img/portfolio/fullsize/6.jpg")} title="Project Name">
